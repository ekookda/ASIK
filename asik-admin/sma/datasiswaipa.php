...
<html>
  ...
  <body>
    ...
    <?php
      ...
      $no=1;
      $id_jurusan = "A01";
      $query = mysqli_query($link, "SELECT id_peserta, nama_siswa, jurusan, naindo, nainggris, namat, biologi, fisika, kimia, keterangan, pesan FROM siswa JOIN nilai USING(id_peserta) WHERE id_jurusan='$id_jurusan'");

      // mulai konfigurasi paging
      $record = 10; // jumlah record per halaman
      $reload = "datasiswaipa.php?pagination=true";
  ...
  -->
    ...
    <div class="container-fluid" style="margin-bottom:50px;">
      <h1 class="text-center">Daftar Siswa kelas IPA</h1><hr>
        ...
        <table class="table table-striped table-hover table-bordered">
          <thead>
            ...
            <tr class="info">
              ...
              <th class="text-center" style="word-wrap:break-word; width:18px;vertical-align:middle;">Biologi</th>
              <th class="text-center" style="word-wrap:break-word; width:18px;vertical-align:middle;">Fisika</th>
              <th class="text-center" style="word-wrap:break-word; width:18px;vertical-align:middle;">Kimia</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center"><?php echo $data['biologi'];?></td>
              <td class="text-center"><?php echo $data['fisika'];?></td>
              <td class="text-center"><?php echo $data['kimia'];?></td>
              ...
              <td class="text-center" style="word-wrap:break-word; width:18px;vertical-align:middle;">
                <a href="editdatasiswaipa.php?id_peserta=<?php echo $data['id_peserta']; ?>"><button type='button' name="btn-edit" class='btn btn-xs btn-info'><span class="glyphicon glyphicon-edit"></span>&nbsp;&nbsp;Edit</button></a>
        ...
        <div class="col-sm-6">
          <div class="pull-left">
            <?php
              ...
              $countsiswa = mysqli_query($link, "SELECT * FROM siswa WHERE jurusan='IPA'");
