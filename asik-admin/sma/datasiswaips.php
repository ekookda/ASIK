...
<html>
  ...
  <body>
    ...
    <?php
      ...
      $no=1;
      $id_jurusan = "S01";
      $query = mysqli_query($link, "SELECT id_peserta, nama_siswa, jurusan, naindo, nainggris, namat, ekonomi, geografi, sosiologi, keterangan, pesan FROM siswa JOIN nilai USING(id_peserta) WHERE id_jurusan='$id_jurusan'");

      // mulai konfigurasi paging
      $record = 10; // jumlah record per halaman
      $reload = "datasiswaips.php?pagination=true";
  ...
  -->
    ...
    <div class="container-fluid" style="margin-bottom:50px;">
      <h1 class="text-center">Daftar Siswa kelas IPS</h1><hr>
        ...
        <table class="table table-striped table-hover table-bordered">
          <thead>
            <tr class="info">
              ...
              <th rowspan="2" class="text-center" style="word-wrap:break-word; width:18px;vertical-align:middle;">Pesan</th>
            ...
            <tr class="info">
              ...
              <th class="text-center" style="word-wrap:break-word; width:18px;vertical-align:middle;">Ekonomi</th>
              <th class="text-center" style="word-wrap:break-word; width:18px;vertical-align:middle;">Geografi</th>
              <th class="text-center" style="word-wrap:break-word; width:18px;vertical-align:middle;">Sosiologi</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center"><?php echo $data['ekonomi'];?></td>
              <td class="text-center"><?php echo $data['geografi'];?></td>
              <td class="text-center"><?php echo $data['sosiologi'];?></td>
              ...
              <td class="text-center" style="word-wrap:break-word; width:18px;vertical-align:middle;">
                <a href="editdatasiswaips.php?id_peserta=<?php echo $data['id_peserta']; ?>"><button type='button' name="btn-edit" class='btn btn-xs btn-info'><span class="glyphicon glyphicon-edit"></span>&nbsp;&nbsp;Edit</button></a>
        ...
        <div class="col-sm-6">
          <div class="pull-left">
            <?php
              ...
              $countsiswa = mysqli_query($link, "SELECT * FROM siswa WHERE jurusan ='IPS'");
