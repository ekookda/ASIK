<?php
  ...
  if (!isset($_SESSION['username'])) {
    ...
    if (isset($_GET['id_peserta'])) {
      ...
      $result = mysqli_query($link, "SELECT id_peserta, nama_siswa, jurusan, naindo, nainggris, namat, biologi, fisika, kimia, keterangan, pesan FROM siswa JOIN nilai USING(id_peserta) WHERE id_peserta='$id'");
  ...
  <body>
    ...
    <div class="alert alert-info" style="margin-top:50px">
      <div class="container">
        ...
        <form class="form-horizontal" method="post" action="proseseditsiswaipa.php" role="form">
          <div class="row">
            <div class="col-sm-6">
              ...
              <div class="form-group">
                <label for="nips" class="control-label col-sm-4">Nilai Fisika :</label>
                <div class="col-sm-7">
                  <input type="text" name="fisika" class="form-control" value="<?php echo $data['fisika']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label for="nips" class="control-label col-sm-4">Nilai Kimia :</label>
                <div class="col-sm-7">
                  <input type="text" name="kimia" class="form-control" value="<?php echo $data['kimia']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label for="nipa" class="control-label col-sm-4">Nilai Biologi :</label>
                <div class="col-sm-7">
                  <input type="text" name="biologi" class="form-control" value="<?php echo $data['biologi']; ?>">
                </div>
              </div>
            </div><!-- /.end col-sm-6 -->
            <div class="col-sm-6">
