...
?>
  ...
  <tr>
    ...
    <td style="font-size:20px"><?php echo $data['name']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="text-transform:capitalize; color:rgba(0,102,255,1); font-weight:bolder; font-size:24px"><?php echo $data['ket'];?></td>
  </tr>
  <tr>
