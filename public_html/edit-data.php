...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form-edit")) {
  $updateSQL = sprintf("UPDATE tb_student SET noujian=%s, name=%s, naindo=%s, nainggris=%s, namat=%s, naipa=%s, ket=%s, adm=%s, komentar=%s WHERE id=%s",
                       GetSQLValueString($_POST['txtNomor'], "text"),
                       GetSQLValueString($_POST['txtNama'], "text"),
                       GetSQLValueString($_POST['txtBindo'], "text"),
                       GetSQLValueString($_POST['txtBing'], "text"),
                       GetSQLValueString($_POST['txtMtk'], "text"),
                       GetSQLValueString($_POST['txtIpa'], "text"),
                       GetSQLValueString($_POST['select'], "text"),
...
<table width="500" border="0" align="center" cellpadding="3" cellspacing="1" class="table-striped table-condensed">
  <tr>
    ...
    <td align="left" valign="middle"><input type="hidden" name="hiddenField" id="hiddenField" value="<?php echo $row_Update['id'];?>"></td>
  </tr>
  <tr>
    <th width="158" align="left" valign="middle" scope="row">Nomor Peserta Ujian</th>
    <td width="327" align="left" valign="middle"><input type="text" name="txtNomor" id="txtNomor" value="<?php echo $row_Update['noujian'];?>"></td>
  </tr>
  <tr>
    <th align="left" valign="middle" scope="row">Nama Siswa</th>
    <td align="left" valign="middle"><input type="text" name="txtNama" value="<?php echo $row_Update['name'];?>" id="txtNama"></td>
  </tr>
  <tr>
    <th align="left" valign="middle" scope="row">Nilai B.Indo</th>
    <td align="left" valign="middle"><input type="text" name="txtBindo" id="txtBindo" value="<?php echo $row_Update['naindo'];?>"></td>
  </tr>
  <tr>
    <th align="left" valign="middle" scope="row">Nilai B.Inggris</th>
    <td align="left" valign="middle"><input type="text" name="txtBing" id="txtBing" value="<?php echo $row_Update['nainggris'];?>"></td>
  </tr>
  <tr>
    <th align="left" valign="middle" scope="row">Nilai Matematika</th>
    <td align="left" valign="middle"><input type="text" name="txtMtk" id="txtMtk" value="<?php echo $row_Update['namat'];?>"></td>
  </tr>
  <tr>
    <th align="left" valign="middle" scope="row">Nilai IPA</th>
    <td align="left" valign="middle"><input type="text" name="txtIpa" id="txtIpa" value="<?php echo $row_Update['naipa'];?>"></td>
  </tr>
  <tr>
    <th align="left" valign="middle" scope="row">Keterangan</th>
    <td align="left" valign="middle"><select name="select" size="1" id="select">
      <option value="" <?php if (!(strcmp("", ucwords($row_Update['ket'])))) {echo "selected=\"selected\"";} ?>></option>
      <option value="LULUS" <?php if (!(strcmp("LULUS", ucwords($row_Update['ket'])))) {echo "selected=\"selected\"";} ?>>LULUS</option>
      <option value="TIDAK LULUS" <?php if (!(strcmp("TIDAK LULUS", ucwords($row_Update['ket'])))) {echo "selected=\"selected\"";} ?>>TIDAK LULUS</option>
      <?php
do {  
?>
      <option value="<?php echo $row_Update['ket']?>"<?php if (!(strcmp($row_Update['ket'], ucwords($row_Update['ket'])))) {echo "selected=\"selected\"";} ?>><?php echo $row_Update['ket']?></option>
      <?php
...
?>
  ...
  <tr>
    <th align="left" valign="middle" scope="row">Administrasi</th>
    <td align="left" valign="middle"><select name="select2" size="1" id="select2">
      <option value="LUNAS" <?php if (!(strcmp("LUNAS", ucwords($row_Update['adm'])))) {echo "selected=\"selected\"";} ?>>LUNAS</option>
      <option value="BELUM LUNAS" <?php if (!(strcmp("BELUM LUNAS", ucwords($row_Update['adm'])))) {echo "selected=\"selected\"";} ?>>BELUM LUNAS</option>
      <?php
do {  
?>
      <option value="<?php echo $row_Update['adm']?>"<?php if (!(strcmp($row_Update['adm'], ucwords($row_Update['adm'])))) {echo "selected=\"selected\"";} ?>><?php echo $row_Update['adm']?></option>
      <?php
} while ($row_Update = mysql_fetch_assoc($Update));
  $rows = mysql_num_rows($Update);
  if($rows > 0) {
...
?>
  ...
  <tr>
    ...
    <td align="left" valign="middle"><textarea name="txtArea" id="txtArea"><?php echo $row_Update['komentar'];?></textarea></td>
  </tr>
  <tr>
    <th scope="row">&nbsp;</th>
    <td>
